...
- Now displays name card of spectated player (to make it work you will switch to the enemy team when spectating, but you will be switched back on respawn
- Now detecting and disabling FFAl
)
## Known issues
- When you spectate someone but your auto titan is alive and kills someone, the enemy team will get rewarded.
- FFA gamemodes do not work (because changing teams).
